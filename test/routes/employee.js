...
describe('Employee routes', function () {
    ...
    it('should not allow to send two same clearance unit numbers at once', function () {
        /*TODO: test for throwing error for same clearance unit numbers*/
    });

    it('should not allow to send request for clearance unit if user already has one waiting request for this clearance unit', function () {
        /*TODO: test if error is thrown if user send a request for already waiting clearance unit*/
    });
